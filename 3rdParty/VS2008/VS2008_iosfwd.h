...
#pragma once
#ifndef _VS2008_IOSFWD_
#define _VS2008_IOSFWD_
#ifndef RC_INVOKED
#include "VS2008_xutility.h"
...
extern __declspec(dllimport) _PGLOBAL fpos_t _Fpz;
extern __declspec(dllimport) _PGLOBAL const streamoff _BADOFF;
